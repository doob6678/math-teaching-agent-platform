...
GRANT SELECT, INSERT, UPDATE ON \`${MATH_AGENT_DB_NAME}\`.student_explanation_checkpoint TO '\''${MATH_AGENT_AI_RUNTIME_DB_USERNAME}'\''@'\''%'\'';
GRANT SELECT, INSERT, UPDATE ON \`${MATH_AGENT_DB_NAME}\`.student_explanation_event TO '\''${MATH_AGENT_AI_RUNTIME_DB_USERNAME}'\''@'\''%'\'';
...
GRANT SELECT, INSERT, UPDATE ON \`${MATH_AGENT_DB_NAME}\`.handout_run_metrics TO '\''${MATH_AGENT_AI_RUNTIME_DB_USERNAME}'\''@'\''%'\'';
GRANT SELECT, INSERT, UPDATE ON \`${MATH_AGENT_DB_NAME}\`.handout_node_metrics TO '\''${MATH_AGENT_AI_RUNTIME_DB_USERNAME}'\''@'\''%'\'';
FLUSH PRIVILEGES;
SQL
'
