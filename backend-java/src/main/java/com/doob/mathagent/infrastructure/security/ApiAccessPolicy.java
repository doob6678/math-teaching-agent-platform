...
public class ApiAccessPolicy {
    ...
    public static ApiAccessPolicy defaultRules() {
        return new ApiAccessPolicy(List.of(
                ...
                new ApiAccessRule("/api/students/learning/explanations", ApiAccessLevel.USER, Set.of("student"), 20, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/intent", ApiAccessLevel.USER, Set.of("student"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/attempts", ApiAccessLevel.USER, Set.of("student"), 60, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/mastery", ApiAccessLevel.USER, Set.of("student"), 0, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/recommendations", ApiAccessLevel.USER, Set.of("student"), 20, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/practice", ApiAccessLevel.USER, Set.of("student"), 5, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/students/learning/path", ApiAccessLevel.USER, Set.of("student"), 0, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/teachers/learning/weak-points", ApiAccessLevel.USER, Set.of("teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/teachers/learning/handout", ApiAccessLevel.USER, Set.of("teacher", "admin"), 10, Duration.ofMinutes(1)),
