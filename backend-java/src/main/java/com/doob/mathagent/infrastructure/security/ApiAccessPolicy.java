...
public class ApiAccessPolicy {
    ...
    public static ApiAccessPolicy defaultRules() {
        return new ApiAccessPolicy(List.of(
                ...
                new ApiAccessRule("/api/system/runtime", ApiAccessLevel.ADMIN, Set.of("teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/auth/register", ApiAccessLevel.PUBLIC, Set.of("*"), 10, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/auth/session", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 60, Duration.ofMinutes(1)),
                ...
                new ApiAccessRule("/api/mcp/configuration/me", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/mcp/keys/", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/mcp/keys", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/mcp/tools/", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/mcp/tools", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 30, Duration.ofMinutes(1)),
                new ApiAccessRule("/api/mcp", ApiAccessLevel.GUEST, Set.of("anonymous", "guest", "student", "teacher", "admin"), 60, Duration.ofMinutes(1)),
                ...
                new ApiAccessRule("/api/knowledge/graph/spine", ApiAccessLevel.USER, Set.of("student", "teacher", "admin"), 60, Duration.ofMinutes(1)),
                ...
                new ApiAccessRule("/api/vector-index/status", ApiAccessLevel.ADMIN, Set.of("teacher", "admin"), 30, Duration.ofMinutes(1)),
