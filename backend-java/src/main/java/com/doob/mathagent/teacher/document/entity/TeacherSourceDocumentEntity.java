package com.doob.mathagent.teacher.document.entity;
...
public class TeacherSourceDocumentEntity {
    ...
    /** Source type, such as feishu, local_path, teacher_resource, qq_bundle, gaokao, or mock_exam. */
    ...
    /** Canonical remote token or normalized local path used for duplicate-source protection. */
    private String sourceIdentity;

    /** SHA-256 of sourceIdentity, indexed because source identities can be long. */
    private String sourceIdentityHash;
    ...
    /** Native Feishu export representation kept independently of unrelated metadata fields. */
    private String feishuExportFormat;

    /** Remote revision reported by the Feishu document API when available. */
    ...
    public void setSourceIdentity(String sourceIdentity) { this.sourceIdentity = sourceIdentity; }

    public String getSourceIdentityHash() { return sourceIdentityHash; }

    public void setSourceIdentityHash(String sourceIdentityHash) { this.sourceIdentityHash = sourceIdentityHash; }
    ...
    public String getFeishuExportFormat() { return feishuExportFormat; }

    public void setFeishuExportFormat(String feishuExportFormat) { this.feishuExportFormat = feishuExportFormat; }

    public String getProviderRevision() { return providerRevision; }

    public void setProviderRevision(String providerRevision) { this.providerRevision = providerRevision; }
