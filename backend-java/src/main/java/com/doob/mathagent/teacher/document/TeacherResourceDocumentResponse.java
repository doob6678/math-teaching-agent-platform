...
public record TeacherResourceDocumentResponse(
    ...
    /**
     * Compatibility constructor retained for resource callers which do not yet have remote sync metadata.
     */
    public TeacherResourceDocumentResponse(
            ...
            List<PreviewFile> previewFiles,
            String parseMode) {
        this(documentId, tenantId, ownerSubjectId, sourceType, title, originalUrl, localPath, permissionScope,
                syncStatus, parseStatus, embeddingStatus, indexStatus, feishuExportFormat, previewFiles, parseMode,
                null, null, null);
    }
