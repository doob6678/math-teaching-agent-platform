...
public record TeacherResourceSearchFilter(
    ...
    public static final TeacherResourceSearchFilter EMPTY =
            new TeacherResourceSearchFilter(List.of(), List.of(), List.of());
    ...
    public boolean empty() {
        return permissionScopes.isEmpty() && documentIds.isEmpty() && tags.isEmpty();
    }
    ...
    private static List<String> normalizeList(List<String> values, boolean upperCase) {
        ...
        return values.stream()
                ...
                .map(value -> upperCase ? value.toUpperCase(java.util.Locale.ROOT) : value)
                .distinct()
                .toList();
    }
}
