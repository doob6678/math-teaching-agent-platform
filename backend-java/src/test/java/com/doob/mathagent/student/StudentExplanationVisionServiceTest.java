...
class StudentExplanationVisionServiceTest {
    ...
    void repairsUtf8ChineseTextMisreadAsLatin1() {
        ...
        String repaired = StudentExplanationVisionService.repairMojibake(mojibake);
    ...
    void leavesNormalChineseTextUnchanged() {
        ...
        assertThat(StudentExplanationVisionService.repairMojibake(normal)).isEqualTo(normal);
    }
}
