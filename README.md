...
**工作台**——教学任务入口与教材资源统计（教材 8 册、文本块 3,673、PDF 页 1,209）：

![工作台](docs/assets/frontend/dashboard.png)

**AI 讲题**——Qwen 式对话界面：模型可切换下拉、"已完成思考"徽标带首字/全程耗时（首字从思考开始计时，决策与检索不计入）、思考与搜索面板展示 AI 自主决策、教材检索与真实页码证据：

![AI 讲题](docs/assets/frontend/teaching-chat.png)
